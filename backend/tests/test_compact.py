...
async def test_compact(mock_server) -> None:
    """Same coverage as the legacy ``main()``; uses the session-scoped mock
    server fixture from conftest instead of managing its own server.
    """
