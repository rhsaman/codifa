...
echo ""
echo "── تست ۳۸: کوردهای ناوبری پیکرها (navChord) + گارد Ctrl+K سایدبار (shouldFocusSearch) ──"
npx esbuild src/lib/shortcuts.test.ts --bundle --platform=node --format=esm \
  --outfile=src/lib/.tmp-shortcuts.mjs >/dev/null 2>&1
node src/lib/.tmp-shortcuts.mjs

rm -f tests/.tmp-fork.mjs tests/.tmp-es.mjs tests/.tmp-rm.mjs tests/.tmp-ls.mjs tests/.tmp-retry.mjs tests/.tmp-cw.mjs tests/.tmp-hb.mjs tests/.tmp-scroll.mjs tests/.tmp-sp.mjs tests/.tmp-uc.mjs tests/.tmp-cu.mjs tests/.tmp-skills.mjs tests/.tmp-skillsCache.mjs tests/.tmp-tr.mjs tests/.tmp-wr.mjs tests/.tmp-eb.mjs tests/.tmp-rb.mjs tests/.tmp-sc.mjs tests/.tmp-ti.mjs tests/.tmp-cb.mjs tests/.tmp-sb.mjs tests/.tmp-cc.mjs tests/.tmp-set.mjs tests/.tmp-rs.mjs tests/.tmp-tn.mjs tests/.tmp-cb2.mjs tests/.tmp-lc.mjs tests/.tmp-fp.mjs tests/.tmp-ucp.mjs tests/.tmp-tnr.mjs src/lib/.tmp-shortcuts.mjs
echo ""
